                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          {selectedLesson.pdfs.map((pdf, idx) => (
                            <button 
                              ...
                              className="flex items-center gap-3 p-4 rounded-xl border border-border bg-muted/30 hover:bg-primary/5 hover:border-primary/30 transition-all group w-full text-left"
                            >
